...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-project-flight2")
    bq_project = Variable.get("bq_project", default_var="data-engineering-2026-484706")
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        project_id="data-engineering-2026-484706",
        region="us-central1",
